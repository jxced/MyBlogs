...
namespace MyBlogs.BLL
{
	...
	{
		private readonly MyBlogs.DAL.BloguserDAL dal=new MyBlogs.DAL.BloguserDAL();
		public BloguserBLL()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyBlogs.Model.Bloguser GetModelByCache(int Id)
		{
			...
			return (MyBlogs.Model.Bloguser)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Bloguser> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Bloguser> DataTableToList(DataTable dt)
		{
			List<MyBlogs.Model.Bloguser> modelList = new List<MyBlogs.Model.Bloguser>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyBlogs.Model.Bloguser model;
