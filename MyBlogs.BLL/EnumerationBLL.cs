...
namespace MyBlogs.BLL
{
	...
	{
		private readonly MyBlogs.DAL.EnumerationDAL dal=new MyBlogs.DAL.EnumerationDAL();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyBlogs.Model.Enumeration GetModelByCache(int Id)
		{
			
			string CacheKey = "EnumerationModel-" + Id;
			...
			return (MyBlogs.Model.Enumeration)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Enumeration> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Enumeration> DataTableToList(DataTable dt)
		{
			List<MyBlogs.Model.Enumeration> modelList = new List<MyBlogs.Model.Enumeration>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyBlogs.Model.Enumeration model;
