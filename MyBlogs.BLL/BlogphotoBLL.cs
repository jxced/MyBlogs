...
namespace MyBlogs.BLL
{
	...
	{
		private readonly MyBlogs.DAL.BlogphotoDAL dal=new MyBlogs.DAL.BlogphotoDAL();
		public BlogphotoBLL()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyBlogs.Model.Blogphoto GetModelByCache(int Id)
		{
			
			string CacheKey = "BlogphotoModel-" + Id;
			...
			return (MyBlogs.Model.Blogphoto)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Blogphoto> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Blogphoto> DataTableToList(DataTable dt)
		{
			List<MyBlogs.Model.Blogphoto> modelList = new List<MyBlogs.Model.Blogphoto>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyBlogs.Model.Blogphoto model;
