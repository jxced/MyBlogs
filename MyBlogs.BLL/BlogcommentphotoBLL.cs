...
namespace MyBlogs.BLL
{
	...
	{
		private readonly MyBlogs.DAL.BlogcommentphotoDAL dal=new MyBlogs.DAL.BlogcommentphotoDAL();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyBlogs.Model.Blogcommentphoto GetModelByCache(int Id)
		{
			
			string CacheKey = "BlogcommentphotoModel-" + Id;
			...
			return (MyBlogs.Model.Blogcommentphoto)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Blogcommentphoto> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyBlogs.Model.Blogcommentphoto> DataTableToList(DataTable dt)
		{
			List<MyBlogs.Model.Blogcommentphoto> modelList = new List<MyBlogs.Model.Blogcommentphoto>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyBlogs.Model.Blogcommentphoto model;
